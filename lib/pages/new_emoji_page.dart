...
class NewEmojiPage extends StatefulWidget {
  const NewEmojiPage({super.key});

  @override
  State<NewEmojiPage> createState() => _NewEmojiPageState();
}

class _NewEmojiPageState extends State<NewEmojiPage> with RouteAware {
  ...
  void _onPressed() {
    ...
    emojiModel.insert(_nameController.text, emojiName);
    context.pop();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(S.current.new_icon, style: TextStyle(fontSize: 18)),
        centerTitle: true,
        elevation: 0,
        actions: [
